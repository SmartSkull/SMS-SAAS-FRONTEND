  ...
  return (
    <section id="contact" className="py-28 px-6 bg-blue-700">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-20 items-start">
        ...
        <Reveal variants={slideR} delay={.1} className="flex-1 w-full">
          <AnimatePresence mode="wait">
            {sent ? (
              <motion.div key="sent" initial={{ opacity: 0, scale: .9 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }}
                className="bg-white rounded-3xl p-12 text-center flex flex-col items-center gap-4 shadow-lg">
              ...
              <motion.form key="form" onSubmit={submit} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
