...
export default function BestStudentsPage() {
  ...
  const printOverall = () => {
    ...
    <table><thead><tr>
      <th style="text-align:center">Rank</th><th>Student</th><th>Class</th><th style="text-align:center">Subjects</th><th style="text-align:center">Cumul Avg</th>
  ...
  const printPerSubject = (ps?: PerSubject) => {
    ...
    const sections = items.map(ps => {
      ...
      return `
        ...
        <table><thead><tr>
          <th style="text-align:center">#</th><th>Student</th><th>Class</th><th style="text-align:center">Cumul Avg</th>
        </tr></thead><tbody>${rows}</tbody></table>`;
    }).join('');
    const win = window.open('', '_blank');
    if (!win) { toast.error('Pop-up blocked. Please allow pop-ups.'); return; }
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                ...
                <th className="p-3 text-center text-xs font-semibold text-gray-500 uppercase">Cumul Avg</th>
              </tr>
            </thead>
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="p-2 text-center text-xs font-semibold text-gray-500 uppercase">Cumul Avg</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-50">
                      {ps.students.map((st) => (
