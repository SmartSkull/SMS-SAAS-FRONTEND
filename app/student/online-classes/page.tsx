            ...
            {classes.map(c => {
              ...
              return (
                <div key={c.id} className="flex items-center gap-4 p-4 hover:bg-gray-50">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${isPast ? 'bg-gray-100' : 'bg-green-100'}`}>
                    <Video size={18} className={isPast ? 'text-gray-400' : 'text-green-600'} />
                  </div>
