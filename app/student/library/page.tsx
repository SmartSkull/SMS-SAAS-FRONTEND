        ...
        <div className="grid md:grid-cols-3 gap-4">
          {items.map((item) => (
            <div key={item.id} className="bg-white rounded-2xl card shadow-sm border border-gray-100 p-5 flex flex-col gap-3">
              ...
              <a href={`https://www.florierenparklaneis.com.ng${item.file_url}`} target="_blank" rel="noreferrer"
                className="flex items-center gap-2 text-xs text-blue-600 font-medium hover:text-blue-700">
